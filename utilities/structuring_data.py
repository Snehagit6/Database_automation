import csv,openpyxl
from utilities.connections import database_connection

def excel_sheet_data():

        try:
            file_name = "G://Database_automation//data//tables_queries.xlsx"
...
def table_data(query):
    ...
    # result_set = cursor.execute('select * from data.business')
    return
